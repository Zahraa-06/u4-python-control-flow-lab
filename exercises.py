...
def check_voting_eligibility():
    ...
    try:
        ...
        if age >= voting_age:
            ...
            print(f"You are {age} years old and not yet eligible to vote. You can vote in {years_left} year(s).")
    
    except ValueError:
        print("Please enter a valid number for your age.")

# Call the function
print("=== Exercise 2: Voting Eligibility ===")
...
def calculate_dog_years():
    try:
        ...
        # Validate age is not negative
        if dog_age < 0:
            print("Dog's age cannot be negative.")
            return
        ...
        if dog_age <= 2:
            ...
            # First 2 years count as 10 each, remaining years count as 7 each
...
def determine_season():
    ...
    if month not in valid_months:
        print("Please enter a valid month abbreviation (Jan - Dec).")
        return
    
    # Validate day range (simplified validation)
    if day < 1 or day > 31:
